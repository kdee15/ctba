...
var RandomNum = Math.floor( Math.random() * totalImages);
	...
	$(document).ready(function(){
		$('.Main').attr("style","background:url('http://www.wpba.za.net/sites/all/themes/WPBATheme/images/RandomBG/BGMain"+RandomNum+".png') top center no-repeat !important");
	});

/* Random Image Generator END */

/* Login Flyout START */
$("div.DivExpand").click(function () {
$("div.DivCollapsed").toggle("slow");
});  
/* Login Flyout END */
